...
export const Image = component$<ImageProps>(({ src, alt }) => {
  ...
  return (
    <picture class="w-full h-full flex items-center justify-center">
      {!isLoaded.value && (
        <div class="inline-block relative w-20 h-20 after:block after:rounded-[50%] after:w-0 after:h-0 after:m-2 after:border-white after:border-[32px] after:border-solid after:border-t-white after:border-r-transparent after:border-b-white after:border-l-transparent animate-spin "></div>
      )}
